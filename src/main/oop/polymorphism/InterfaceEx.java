 ...
 */
interface ChildInterface extends InterfaceEx, ParentInterface {
 ...
 */
class ImplementedClass1 extends Parent implements InterfaceEx, ParentInterface {
    ...
    public void abstractMethod1() {
       System.out.println("implemented method abstractMethod1() from InterfaceEx"); 
    }

    @Override
    public void abstractMethod2() {
        System.out.println("implemented method abstractMethod2() from InterfaceEx");
    }
...
class ImplementedClass2 implements InterfaceEx, ParentInterface {
    @Override
    public void parentAbstractMethod() {
...
class ImplementedTest {
    public void testPolymorphismOfImplementedClass() {
         ...
         */
        InterfaceEx iex = (InterfaceEx) new ImplementedClass1(123L, "ic1");
        iex = (InterfaceEx) new ImplementedClass2();
    }
}